...
public class UserVO {
	...
	private int mail_auth;	//11/14일 수정
	...
	public String toString() {
		return "UserVO [id=" + id + ", password=" + password + ", name=" + name + ", point=" + point + ", rank=" + rank
				+ ", blacklist=" + blacklist + ", profileimg=" + profileimg + ", tel=" + tel + ", post=" + post
				+ ", addr=" + addr + ", addr2=" + addr2 + ", ticket=" + ticket + ", boardCnt=" + boardCnt
				+ ", tradeCnt=" + tradeCnt + ", commentCnt=" + commentCnt + ", email=" + email + ", mail_key="
				+ mail_key + ", mail_auth=" + mail_auth + "]";
	}
