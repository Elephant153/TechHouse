...
<body>
	...
	<div class="container" style="margin-bottom: 350px; margin-top: 150px;">
		...
		<div class="form-group mx-5">
			...
			<span class = "text_in">이메일</span>
			<input class="email_input inline-block w-100" type="text" placeholder="이메일" name="email"><br>
			<span class="final_email_ck">이메일을 입력해주세요.</span><br>
			...
			<span class = "text_in">상세주소</span>
			<input type="text" class = "form-control" id="addr2" name="addr2" maxlength="20" placeholder="상세주소"><br>
			<span class = "text_in">프로필</span>
			<input class="profil_input" style="color : green;" type="file" name="file"><br>
		</div>
...
<script>
		...
		$(document).ready(function(){
			...
			$(".join_button").click(function(){
		        ...
		        if(idCheck&&idckCheck&&pwCheck&&pwckCheck&&pwckcorCheck&&nameCheck&&nameckCheck&&emailCheck&&telCheck){
